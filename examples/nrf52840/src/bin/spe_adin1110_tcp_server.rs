...
//! A simple HTTP server using the ADIN1110 Ethernet Tranceiver.
//! Designed for use with Adafruit's Feather nRF52840 Express.
...
async fn main(spawner: Spawner) {
    ...
    let adin_1110_ncs = Output::new(adin1110_cs_pin, Level::High, OutputDrive::Standard);
